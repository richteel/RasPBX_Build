...
$title = "FreePBX Outgoing Call Log";
$description = "List of outgoing calls from OBi110 ATA.";
...
$sqlCalls = file_get_contents("./queries/outbound.txt",  FILE_USE_INCLUDE_PATH);
