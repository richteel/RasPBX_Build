...
if (isset($_POST['submit_add']))
{
	...
	if ($tmpInitRES = $db->query($tmpInitSQL))
	{
		// show editor
...
function output_view_contacts ()
{
	...
	$chk = $db->query($member_of_sql);
	$member_of_qry = $db->query($member_of_sql);
	...
	if (isset($_POST['member_of']) || isset($_GET['ob']) || isset($_GET['mbr_of']))
	{
		...
		{	
			...
			if ($p = $parent_result->fetch_assoc())
			{
